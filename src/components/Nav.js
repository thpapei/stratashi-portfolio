  ...
  return (
    <div className='nav'>
      <ul>
        ...
        <li><Link to='pictures' spy={true} smooth={true} offset={-100} duration={500}>Pictures</Link></li>
        <li><Link to='videos' spy={true} smooth={true} offset={-100} duration={500}>Videos</Link></li>
